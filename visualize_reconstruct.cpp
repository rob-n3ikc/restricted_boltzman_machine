...
while(d->get_next())
  ...
  d->threshold(100);
	...
	a[ibest]->reconstruct_best( window_size, encoded, d->reconstructed);
	d->xpm_reconstruct(oop);
	a[ibest]->reconstruct( window_size, encoded, d->reconstructed);
	d->xpm_reconstruct(oop);
